  ...
  "relative w-full rounded-lg border px-4 py-3 text-sm grid has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] grid-cols-[0_1fr] has-[>svg]:gap-x-3 gap-y-0.5 items-start [&>svg]:size-4 [&>svg]:translate-y-0.5 [&>svg]:text-current",
  {
    variants: {
      variant: {
        ...
        warning:
          "text-amber-600 dark:text-amber-400 bg-amber-500/8 border-amber-500/30 [&>svg]:text-current",
        info: "text-sky-600 dark:text-sky-400 bg-sky-500/8 border-sky-500/30 [&>svg]:text-current",
      },
    },
    defaultVariants: {
      variant: "default",
